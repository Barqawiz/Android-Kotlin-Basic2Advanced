...
class SleepQualityFragment : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        val viewModelFactory = SleepQualityViewModelFactory(arguments.sleepNightKey.toLong(), dataSource)
        ...
        // observer
        viewModel.eventToSleepTracker.observe(viewLifecycleOwner) { status ->
            if (status == true) {
