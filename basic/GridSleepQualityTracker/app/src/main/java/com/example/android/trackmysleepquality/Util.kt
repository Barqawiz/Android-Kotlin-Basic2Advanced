...
fun convertNumericQualityToDrawable(quality: Int): Int {

    var qualityDrawable = R.drawable.ic_launcher_sleep_tracker_foreground
    when (quality) {
        0 -> qualityDrawable = R.drawable.ic_sleep_0
        1 -> qualityDrawable = R.drawable.ic_sleep_1
        2 -> qualityDrawable = R.drawable.ic_sleep_2
        3 -> qualityDrawable = R.drawable.ic_sleep_3
        4 -> qualityDrawable = R.drawable.ic_sleep_4
        5 -> qualityDrawable = R.drawable.ic_sleep_5
        else -> R.drawable.ic_launcher_sleep_tracker_foreground
    }
    return qualityDrawable
}
...
fun formatNights(nights: List<SleepNight>, resources: Resources): Spanned {
    ...
    Log.i("track_me", "return formatedNights: ${sb.toString()}")
...
/*view holder for recycle adapter*/
...
class SleepNightDiffCallback: DiffUtil.ItemCallback<DataItem>() {
    ...
    override fun areContentsTheSame(oldItem: DataItem, newItem: DataItem): Boolean {
        // perform equality check on all items. because it is """data class"""
        // data class automatically define equals and few other methods
